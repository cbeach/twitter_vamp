...
class database_interface:
    ...
    def __init__(self, host='localhost', database='twitter_test', user='twittertest', password='twitter_test'):

        self.db_init(host, database, user, password)
        self.create_tables()
        
    
    def db_init(self,host='localhost', database='twitter_test', user='twittertest', password='twitter_test'):
        #Initialize the connection to the database
        try:
            self.db_con = MySQLdb.connect(host, database, user, password)
